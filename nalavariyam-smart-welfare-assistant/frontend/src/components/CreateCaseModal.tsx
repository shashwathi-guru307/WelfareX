    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 dark:bg-black/70">
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-slate-700">
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2.5 text-sm bg-white dark:bg-[#0a1a1e] border border-gray-200 dark:border-[#1a3a40] rounded-lg focus:outline-none focus:ring-2 focus:ring-accent/30 dark:text-white"
            >
          ...
          {selectedWorker && (selectedWorker as any).board_name && (
            <div className="p-3 bg-gray-50 dark:bg-[#0a1a1e]/50 rounded-lg">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 text-sm bg-white dark:bg-[#0a1a1e] border border-gray-200 dark:border-[#1a3a40] rounded-lg focus:outline-none focus:ring-2 focus:ring-accent/30 dark:text-white placeholder-gray-400"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2.5 text-sm bg-white dark:bg-[#0a1a1e] border border-gray-200 dark:border-[#1a3a40] rounded-lg focus:outline-none focus:ring-2 focus:ring-accent/30 dark:text-white placeholder-gray-400 resize-none"
            />
          </div>
        </div>
        ...
        <div className="px-6 py-4 border-t border-gray-100 dark:border-slate-700 flex items-center justify-end gap-3">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-[#0a1a1e] border border-gray-300 dark:border-[#1a3a40] rounded-lg hover:bg-gray-50 dark:hover:bg-slate-600 transition-colors"
          >
            Cancel
          </button>
          <button
