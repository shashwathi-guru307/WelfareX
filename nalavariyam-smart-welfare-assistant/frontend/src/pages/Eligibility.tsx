      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-[10px] font-medium text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-[#0a1a1e] px-2 py-0.5 rounded">
              v4.0.0
            </span>
          </div>
          ...
          <div className="flex items-end gap-4">
            <div className="flex-1">
              ...
              <select
                ...
                className="block w-full px-3 py-2.5 border border-gray-200 dark:border-[#1a3a40] rounded-lg text-sm bg-gray-50 dark:bg-[#0a1a1e] dark:text-white focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent"
              >
        ...
        {analysis && !analyzing && (
          <>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm overflow-hidden">
              ...
              {/* Summary Stats */}
              <div className="grid grid-cols-2 md:grid-cols-5 gap-px bg-gray-100 dark:bg-[#0a1a1e]">
              ...
              <div className="px-5 py-3 bg-gray-50 dark:bg-[#0a1a1e]/50 border-t border-gray-100 dark:border-slate-700 flex items-center justify-between">
                <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className={`px-2.5 py-1 text-[11px] font-medium rounded-full transition-colors ${
                    categoryFilter === cat
                      ...
                      : 'text-gray-500 bg-gray-50 dark:bg-[#0a1a1e] border border-gray-200 dark:border-[#1a3a40] hover:bg-gray-100 dark:hover:bg-slate-600'
                  }`}
                >
    ...
    <div className={`bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm overflow-hidden`}>
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                {result.variant_name && (
                  <span className="text-[10px] font-medium text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-[#0a1a1e] px-2 py-0.5 rounded truncate hidden sm:inline">
                    {result.variant_name}
                  </span>
                )}
              </div>
      ...
      {isExpanded && (
        <div className="px-5 py-4 border-t border-gray-100 dark:border-slate-700 space-y-4">
          ...
          {/* Source & Verification */}
          {result.source_info && (
            <div className="bg-gray-50 dark:bg-[#0a1a1e]/50 rounded-lg p-3">
      ...
      >
        ...
        <div className="p-6 space-y-5">
          ...
          <div>
            ...
            <div className="w-full bg-gray-200 dark:bg-[#0a1a1e] rounded-full h-2">
              <div
          ...
          {/* Source Information */}
          {result.source_info && (
            <div className="bg-gray-50 dark:bg-[#0a1a1e]/50 rounded-lg p-4">
              <p className="text-[11px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Source Scheme Information</p>
        ...
        <div className="px-6 py-4 border-t border-gray-100 dark:border-slate-700 flex items-center justify-end gap-3">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-400 bg-white dark:bg-[#0a1a1e] border border-gray-300 dark:border-[#1a3a40] rounded-lg hover:bg-gray-50 dark:hover:bg-slate-600 transition-colors"
          >
            Close
          </button>
        </div>
