...
export default function Workers() {
  ...
  const [boardFilter, setBoardFilter] = useState(() => searchParams.get('board_id') || '');
  const [statusFilter, setStatusFilter] = useState('');
  const [districtFilter, setDistrictFilter] = useState(() => searchParams.get('district') || '');
  const [talukFilter, setTalukFilter] = useState(() => searchParams.get('taluk') || '');
  ...
  const { data, loading, error, refetch } = useApi(
    ...
    [search, boardFilter, statusFilter, districtFilter, talukFilter, occupationFilter, renewalStatusFilter, sortBy, sortDir, page],
  );

  useEffect(() => {
    setPage(1);
  }, [search, boardFilter, statusFilter, districtFilter, talukFilter, occupationFilter, renewalStatusFilter, sortBy, sortDir]);
  ...
  const activeFilterCount = [boardFilter, statusFilter, districtFilter, talukFilter, occupationFilter, renewalStatusFilter].filter(Boolean).length;
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="relative flex-1 min-w-[250px]">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 text-sm bg-gray-50 dark:bg-[#0a1a1e] border border-gray-200 dark:border-[#1a3a40] rounded-lg focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent placeholder-gray-400 text-gray-900 dark:text-gray-100"
              />
            </div>
            ...
            <select
              ...
              className="px-3 py-2.5 text-sm bg-gray-50 dark:bg-[#0a1a1e] border border-gray-200 dark:border-[#1a3a40] rounded-lg focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent text-gray-700 dark:text-gray-300 min-w-[180px]"
            >
            ...
            <select
              ...
              className="px-3 py-2.5 text-sm bg-gray-50 dark:bg-[#0a1a1e] border border-gray-200 dark:border-[#1a3a40] rounded-lg focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent text-gray-700 dark:text-gray-300 min-w-[160px]"
            >
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-2.5 text-sm font-medium rounded-lg border transition-colors ${
                showFilters || activeFilterCount > 0
                  ...
                  : 'bg-gray-50 dark:bg-[#0a1a1e] text-gray-600 dark:text-gray-400 border-gray-200 dark:border-[#1a3a40] hover:bg-gray-100 dark:hover:bg-slate-600'
              }`}
            >
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <div className="flex items-center gap-1">
              <select
                ...
                className="px-3 py-2.5 text-sm bg-gray-50 dark:bg-[#0a1a1e] border border-gray-200 dark:border-[#1a3a40] rounded-lg focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent text-gray-700 dark:text-gray-300"
              >
              ...
              <button
                ...
                className="p-2.5 text-gray-500 hover:text-gray-700 bg-gray-50 dark:bg-[#0a1a1e] border border-gray-200 dark:border-[#1a3a40] rounded-lg hover:bg-gray-100 dark:hover:bg-slate-600 transition-colors"
          ...
          {showFilters && (
            <div className="flex flex-wrap items-center gap-3 mt-3 pt-3 border-t border-gray-100 dark:border-slate-700">
              <select
                ...
                onChange={(e) => { setDistrictFilter(e.target.value); setTalukFilter(''); }}
                className="px-3 py-2 text-sm bg-gray-50 dark:bg-[#0a1a1e] border border-gray-200 dark:border-[#1a3a40] rounded-lg focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent text-gray-700 dark:text-gray-300 min-w-[160px]"
              >
              ...
              {districtFilter && (
                ...
                >
                  ...
                  {[...new Set(data?.workers?.filter(w => w.district === districtFilter).map(w => w.taluk).filter(Boolean) as string[])].sort().map(t => (
              ...
              {activeFilterCount > 0 && (
                <button
                  onClick={() => { setBoardFilter(''); setStatusFilter(''); setDistrictFilter(''); setTalukFilter(''); setOccupationFilter(''); setRenewalStatusFilter(''); }}
            ...
            <>
              <div className="overflow-x-auto">
                <table className="min-w-full">
                  <thead>
                    <tr className="border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-[#0a1a1e]/50">
                      {[
