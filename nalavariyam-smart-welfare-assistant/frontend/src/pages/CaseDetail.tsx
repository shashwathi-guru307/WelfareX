          ...
          <div className="space-y-3">
            <div>
              <DarkSelect
                ...
                stringOptions={['NEW', 'UNDER_REVIEW', 'DOCUMENTS_PENDING', 'ELIGIBILITY_REVIEW', 'READY_FOR_SUBMISSION', 'FOLLOW_UP_REQUIRED', 'COMPLETED', 'REJECTED', 'CLOSED']}
            ...
            {newStatus === 'CLOSED' && (
              <div>
                ...
                stringOptions={['BENEFIT_PROCESSED', 'NOT_ELIGIBLE', 'APPLICANT_WITHDREW', 'DUPLICATE_CASE', 'NO_RESPONSE', 'OTHER']}
          ...
          <div className="space-y-3">
            <div>
              <DarkSelect
                ...
                stringOptions={['CALL_APPLICANT', 'DOCUMENT_COLLECTION', 'DOCUMENT_VERIFICATION', 'ELIGIBILITY_REVIEW', 'RENEWAL_FOLLOWUP', 'SCHEME_REVIEW', 'OTHER']}
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Title *</label>
              <input type="text" value={taskForm.title} onChange={e => setTaskForm(f => ({ ...f, title: e.target.value }))} className="w-full px-3 py-2.5 text-sm bg-white dark:bg-[#0a1a1e] border border-gray-200 dark:border-[#1a3a40] rounded-lg text-gray-900 dark:text-gray-100" placeholder="Task title..." />
            </div>
            <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <DarkSelect
                  ...
                  stringOptions={['LOW', 'MEDIUM', 'HIGH', 'URGENT']}
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Due Date</label>
                <input type="date" value={taskForm.due_date} onChange={e => setTaskForm(f => ({ ...f, due_date: e.target.value }))} className="w-full px-3 py-2.5 text-sm bg-white dark:bg-[#0a1a1e] border border-gray-200 dark:border-[#1a3a40] rounded-lg text-gray-900 dark:text-gray-100" />
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Assigned To</label>
              <input type="text" value={taskForm.assigned_to} onChange={e => setTaskForm(f => ({ ...f, assigned_to: e.target.value }))} className="w-full px-3 py-2.5 text-sm bg-white dark:bg-[#0a1a1e] border border-gray-200 dark:border-[#1a3a40] rounded-lg text-gray-900 dark:text-gray-100" placeholder="Staff name..." />
            </div>
          </div>
          <div className="flex justify-end gap-3 mt-4">
          ...
          <div className="space-y-3">
            <div>
              <DarkSelect
                ...
                stringOptions={['EDUCATION_CERTIFICATE', 'ID_PROOF', 'INCOME_CERTIFICATE', 'BANK_DETAILS', 'MEDICAL_CERTIFICATE', 'REGISTRATION_PROOF', 'PHOTO', 'OTHER']}
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Document Name *</label>
              <input type="text" value={docForm.document_name} onChange={e => setDocForm(f => ({ ...f, document_name: e.target.value }))} className="w-full px-3 py-2.5 text-sm bg-white dark:bg-[#0a1a1e] border border-gray-200 dark:border-[#1a3a40] rounded-lg text-gray-900 dark:text-gray-100" placeholder="e.g., Education Certificate" />
            </div>
