...
-- ============================================================
-- Welfare Boards — Phase 2 demo boards (kept for demo workers)
-- ============================================================
INSERT OR IGNORE INTO welfare_boards (name, description, is_active, registration_requirements) VALUES
('Tamil Nadu Construction Workers Welfare Board', 'Welfare board for construction workers across Tamil Nadu. Covers masons, carpenters, plumbers, electricians, and general labourers in the construction sector.', 1, 'Valid ID proof, employment certificate from contractor, age 18-60, Aadhaar card.'),
('Tamil Nadu Domestic Workers Welfare Board', 'Welfare board for domestic workers including housemaids, cooks, nannies, and elderly care workers.', 1, 'Employment letter from employer, valid ID proof, age 18-58, proof of residence.'),
('Tamil Nadu Automobile Workers Welfare Board', 'Welfare board for workers in automobile manufacturing and ancillary units.', 1, 'Employment certificate from registered unit, valid ID proof, age 18-58.'),
('Tamil Nadu Handloom Workers Welfare Board', 'Welfare board for handloom weavers and textile workers in the traditional sector.', 1, 'Weaver identity card or cooperative membership, valid ID proof, age 18-60.'),
('Tamil Nadu Beedi Workers Welfare Board', 'Welfare board for beedi rolling workers and allied tobacco industry workers.', 1, 'Employment certificate, valid ID proof, age 18-55, medical fitness certificate.');
